...
# tạo button âm thanh
button_sound_surface=pygame.image.load('assets/sound2.png').convert_alpha()
button_sound_rect= button_sound_surface.get_rect(center=(400 ,20 ))
class Button():
    ...
    def draw(self):
        ...
        #chẹc mouse over and clicked conditions
